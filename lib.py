...
SELF_CONFIG_NAME = "kanshi-gui.json"
KANSHI_CONFIG_NAME = "config-kanshi-gui"
...
def write_configs_to_disk(config: Config):
    """
    Will write the given config into our state, kanshi-gui.json as well as overwriting
...
def read_self_config() -> Config:
    """
    Will attempt to read kanshi-gui.json, and turn it into a usable kanshi config,
